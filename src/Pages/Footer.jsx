					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/sanzmd23/?hl=id" class="hover:underline">
										SanzMD
									</a>
								</li>
								<li>
									<a href="https://youtube.com/@sanzmd?si=jKIqouaO9PW-sIEx" class="hover:underline">
										Solo Coding
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/litevi.itclass?igsh=cnQxZ3pheXcwcHB2" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
									<a href="https://youtube.com/@liteviclas-i2x?si=LJ0xOyTq0KnGdxLn" class="hover:underline">
										Youtube
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Litevi Class | Di Kelola Oleh Siswa XI.C
						</p>
					</div>
				</div>
			</div>
