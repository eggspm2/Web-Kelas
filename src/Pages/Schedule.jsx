...
const Schedule = () => {
    ...
    piketGroup = [
        ["Bagas", "Rafi", "Ayu", "Naura", "Khumai", "Azzahrah", "Valiant"],
        ["Kiara", "Anggun", "Sekar", "Ratie", "Aden", "Fatir"],
        ["Raisya", "Fabian", "Dinda", "Andea", "Ikhsan", "Fei"],
        ["Sinta", "Anjas", "Seril", "Salman", "Yeyen", "Nova"],
        ["Ana", "Ardi", "Satria", "Nadin", "Chalista", "Hasbi", "Gebran"],
    ]
