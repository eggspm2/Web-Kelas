	...
	return (
		<>
			<div
				...
				<div className="flex justify-center items-center text-sm">07.35-09.00</div>
			</div>
			<div
			...
			<div
				...
				<div className="flex justify-center items-center text-sm">09.45-12.10</div>
			</div>
			<div
				...
				<div className="flex justify-center items-center text-sm">12.10-13.10</div>
			</div>
			<div
				className=" border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3"
				data-aos="fade-up"
				...
				<div className="flex justify-center items-center text-sm">13.10-14.25</div>
			</div>
			...
			<div
				...
				<div className="flex justify-center items-center text-sm">14.25-16.05</div>
			</div>
		</>
	)
}
